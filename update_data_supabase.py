...
# Definindo os anos (idealmente, importe de src.config, mas vamos defini-los aqui para o script ser auto-contido)
# Use os mesmos valores que estão no seu src/config.py


# ===================================================================
# --- 4. QUERIES PARAMETRIZADAS (MODIFICADAS) ---
# ===================================================================
...
# (Modificadas de = :municipio para IN :lista_municipios)
QUERY_EMPREGO_CNAE = """
SELECT 
...
# ===================================================================
# --- 5. FUNÇÃO DE PROCESSAMENTO E UPLOAD (MODIFICADA) ---
# ===================================================================
...
def process_and_upload(
    ...
    try:
        ...
        # 1. Executar a query e carregar para o DataFrame
        print(
        ...
        # 3. Apagar dados existentes na tabela de destino
        ...
        supabase_client.table(target_table_name).delete().gt(
            "ano", 0
        ).execute()  # Filtro genérico

        # 4. Inserir dados em lotes
