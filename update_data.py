...
def main():
    ...
    tasks = [
        ...
        (QUERY_CNPJ_CNAE_SALDO, "dados_cnpj_cnae_saldo", params_principais),
        (QUERY_MEI_CNAE, "dados_mei_cnae", params_principais),
        (QUERY_MEI_CNAE_SALDO, "dados_mei_cnae_saldo", params_principais),
    ]
